...
1 - Indique quais símbolos podem preencher as lacunas a seguir. Os símbolos
possíveis são: $$\in$$, $$\notin$$, $$\subset$$, $$\supset$$, $$\not\subset$$ e
$$\not\supset$$. Cada lacuna pode ser preenchida por **três** símbolos!

* $$\{1, 2\} \hspace{0.2cm} \underline{} \hspace{0.2cm} \{1, 2, 3, \{1, 2\}\}
\rightarrow$$ Resposta: $$\in$$, $$\subset$$ e $$\not\supset$$
* $$5 \hspace{0.2cm} \underline{} \hspace{0.2cm} \{\{4, 5\}, \{5, 6\}\}
\rightarrow$$ Resposta:
* $$\{5\} \hspace{0.2cm} \underline{} \hspace{0.2cm} \{\{4, 5\}, \{5, 6\}\}
\rightarrow$$ Resposta:
* $$\{2, 3, \emptyset\} \hspace{0.2cm} \underline{} \hspace{0.2cm} \emptyset
\rightarrow$$ Resposta:
* $$\{3\} \hspace{0.2cm} \underline{} \hspace{0.2cm} \{3, \{\{3\}\}\}
\rightarrow$$ Resposta:

2 - Explique porque as seguintes afirmativas são verdadeiras:
