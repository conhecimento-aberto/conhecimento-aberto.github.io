...
Assim sendo, as afirmações $$E \subset F$$ e $$F \supset E$$ são equivalentes.
...
Logo, as afirmações $$F \not\subset E$$ e $$E \not\supset F$$ são equivalentes.
...
os elementos de $$\{1, 2, 3, \{1, 2\}\}$$ são também elementos de $$\{1, 2\}$$.
Logo vemos que isto não é verdade pois $$\{1, 2\}$$ (elemento do conjunto da
esquerda) não é um elemento do conjunto da direita, cujos elementos são $$1$$ e
$$2$$. Logo, o símbolo $$\supset$$ não é adequado.
...
$$\{1, 2\}$$ (elemento do conjunto da direita) não pertence ao conjunto da
esquerda. Logo, o símbolo $$\not\supset$$ é sim adequado!
